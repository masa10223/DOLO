...
> **実装状況 (2026-08-07):** Phase 1 と Phase 2 の推論経路を実装済み。`dolo gui` から
> defaultモデル検出、動画アップロード／サーバーパス入力、ジョブ進捗・中断、CSV / JSONL /
> MOV / GIF、個体別集計、再現用 `run.json` まで利用できる。操作方法は `docs/GUI.md` を参照。
