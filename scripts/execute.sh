...
nohup python3 excecute.py --radius 25 --max_gap 10  --frame_interval 5 --thr_frame 1000  --proximity_dist 50 > ./logs/summary_and_plots_radius25_maxgap10_frameinterval5_thr1000_prox50_overfits.out &
